...
import { Feather, Volume2, XCircle, PlusCircle, Sparkles, Trash2 } from 'lucide-react';
    ...
    <div className="flex flex-col h-full p-8 relative bg-[#FDFBF7]">
      ...
      <div className="flex-1 flex flex-col min-h-0">
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar mb-8 space-y-3 pr-1">
          {samples.length === 0 ? (
            <div className="bg-white/50 border-2 border-dashed border-[#F2EEE6] rounded-3xl p-8 text-center flex flex-col items-center">
              <Feather className="text-[#F2EEE6] w-8 h-8 mb-3" />
